function [outp,outptype,outpm]=ltikernelfit2(kern,type,dt,starting_paramguess,lnmstruct)
...
elseif strcmp(type,'3offc1')  %feed-forward cascade type one (non-branching)
    if nargin<4
...
elseif strcmp(type,'3o5wangp2_lneval2')
    disp(['fitting ' type]);
    if nargin<4
         starting_paramguess=[2 2 20 -5 -15];
    end
...
elseif strcmp(type,'3o5gcexactneg')
    if nargin<4
         starting_paramguess=[2 2 20 -5 -15];
         disp('using default 5-value starting paramguess');
    end
...
elseif strcmp(type,'3oo2')  %Manuel's O2 chip
    if nargin<4
         starting_paramguess=[2 2 20 -5 -15];
    end
...
elseif strcmp(type,'3oo22')  %Manuel's O2 chip V2
    if nargin<4
         starting_paramguess=[2 2 20 -5 -15];
    end
